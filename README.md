...
- [弹弹play开放平台](https://doc.dandanplay.com/open/)
  ...
  感谢弹弹play开放平台提供弹幕服务接口支持。项目中使用的相关代理实现可参考 [kaloscope/danmaku](https://github.com/kaloscope/danmaku) 仓库。

- 第三方依赖与开源社区

  本项目构建在众多优秀的开源项目之上，感谢所有开发者与贡献者的持续投入。完整的第三方依赖列表及其对应开源协议见 [LICENSES.md](LICENSES.md) 文件。
